<script lang="ts">
  ...
  async function handleDrop(e: CustomEvent<any>) {
    ...
    if (acceptedFiles.length) {
      ...
      errorMessage =
        "Could not upload the given file. It must be an image and less than 10mb.";
    }
  }
  ...
  <div class="upload-area">
    <div class="upload-container">
      ...
      {:else}
        ...
        >
          <Icon icon="bi:camera-full" width={"40px"} />
...
{:else if !booksSuccessfullyAdded}
  <div class="found-books">
    ...
    <Button onclick={addAllBooks}>All all books</Button>
  </div>
{:else}
  <h4>
